...
def main():
    ...
    print(f"  o/n range 28313-28735   +307 (+1.08%)  [Mon Aug 3 RTH, into 28726 shelf]")
    ...
    print(f"\nToS ZONE INPUTS ({cur_date}) — copy these zone lines straight into the ToS study each rerun:")
