# =====================================================================
# NQ Confluence — three-filter system + clean structure (ThinkOrSwim)
#   FILTER 1 LOCATION  : A+/DENSE zones (edit ZONE inputs each rerun)
...
#   + STRUCTURE : last swing hi/lo lines (areas of significance) + BULL/BEAR label
#
...
# Paste the WHOLE block into Studies > Create > thinkScript Editor.
# =====================================================================
declare upper;
...
input z1_hi = 28763.0;  input z1_lo = 28701.0;  input z1_resist = yes;   # 28726 DENSE shelf
input z2_hi = 28641.0;  input z2_lo = 28390.0;  input z2_resist = yes;   # 28549 DENSE
...
# ---- SIGNALS (trend-aligned, generalised across all 4 zones) ----
...
Alert(fadeShort, "NQ FADE-short", Alert.BAR, Sound.Ring);
Alert(fadeLong,  "NQ FADE-long",  Alert.BAR, Sound.Ring);
Alert(brkShort,  "NQ BREAK-short", Alert.BAR, Sound.Bell);
Alert(brkLong,   "NQ BREAK-long",  Alert.BAR, Sound.Bell);

# ---- STRUCTURE (clean): last swing hi/lo = areas of significance ----
