...
Alert(fadeShort, "SPY FADE-short", Alert.BAR, Sound.Ring);
Alert(fadeLong,  "SPY FADE-long",  Alert.BAR, Sound.Ring);
Alert(brkShort,  "SPY BREAK-short", Alert.BAR, Sound.Bell);
Alert(brkLong,   "SPY BREAK-long",  Alert.BAR, Sound.Bell);
...
# ---- status labels ----
AddLabel(yes, "SPY Macro " + (if bias > 0 then "UP" else if bias < 0 then "DOWN" else "MIXED"),
