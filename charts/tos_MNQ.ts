...
Alert(fadeShort, "MNQ FADE-short", Alert.BAR, Sound.Ring);
Alert(fadeLong,  "MNQ FADE-long",  Alert.BAR, Sound.Ring);
Alert(brkShort,  "MNQ BREAK-short", Alert.BAR, Sound.Bell);
Alert(brkLong,   "MNQ BREAK-long",  Alert.BAR, Sound.Bell);
...
# ---- status labels ----
AddLabel(yes, "MNQ Macro " + (if bias > 0 then "UP" else if bias < 0 then "DOWN" else "MIXED"),
